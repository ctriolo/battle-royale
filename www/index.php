<?php
  ...
  if (facebook_get_user()) header('Location: http://battleroyale.mobi/profile.php');
?>
...
<body>
  <div class='container'>
    <div class='hero-unit' style='text-align:center'>
      ...
      <a href="<?php echo facebook_get_log_in_url(); ?>" class='btn primary large'>Log In Using Facebook &raquo;</a>
    </div>
  </div>
  <footer class="footer">
